                    ...
                    if user_unique_starts is not None:
                        ...
                        def update(df, edited_df):
                            ...
                            for index, row in df.iterrows():
                                ...
                                st.write(f"{row['ID']}, {edited_df.loc[edited_df['ID'] == row['ID'], 'ST']}")
                                #st.write()
                        ...
                        edited_df = st.data_editor(edited_df, num_rows='dynamic', on_change=change_state, args=(edited_df,), disabled=True)
                        #placeholder1.empty()
                        update(df, edited_df)
